...
function obtenerretencionicas() {
  ...
  function editarEmpresa(id){//render al editar
  var url_edit = 'miempresa/edit.html';
  
  if(localStorage.nivelperfil == 2){
  
      var bool = confirm('Deseas Modificar Tu empresa esta opcion es de cuidado ya que Miggo usa parte de la información para su funcionamiento?');
          if(bool){
              $('#main_content').load(url_front + url_edit);
          }
    }else{
          var mensaje = 'No tiene los permisos para Editar la Empresa';
  ...
  $( document ).ready(function() {
    ...
    $("#editarempresa").on("click",editarEmpresa);
