$("#formEmpresa").change(function(e) {
    ...
    $.ajax({
        method: "POST",
        url: url_back + "empresas/"+localStorage.empresa_id,
        headers: { 
    ...
    if(id){
      ...
      $('#mymodal').load('../miempresa/retencionicas/show.html',function(){
    ...
    if(id){
      ...
      $('#mymodal').load('../miempresa/retencionicas/edit.html',function(){
    ...
    var crearRetencionica = function(e){ //TODO: error se debe crear con la empresa que se edita
        ...
        $('#mymodal').load('../miempresa/retencionicas/add.html',function(){
    ...
    var organizarDatos = function( data ) {  //TODO: revisar este codigo
        ...
        data.forEach(element => {
            arrSocio = [
                ...
                element.tercero.apellidos? element.tercero.apellidos : '',
                element.tercero.celular,
                element.numeroacciones? element.numeroacciones : '',
                element.porcentajeparticipacion? element.porcentajeparticipacion : '',
            ];
    
            arrSocio.push('<div class="col"> <button class="btn btn-success btn-sm" type="submit" onclick="verSocio('+ element.id +')" data-toggle="modal" data-target="#exampleModalLong"><i class="nav-icon fas fa-search" aria-hidden="true"></i></button> &nbsp; <button class="btn btn-info btn-sm" type="submit" onclick="editarSocio('+ element.id +')"><i class="nav-icon fa fa-pencil-alt" aria-hidden="true"></i></button> &nbsp;  <button class="btn btn-danger btn-sm" type="submit" onclick="eliminarSocio('+ element.id +')"><i class="nav-icon fa fa-times" aria-hidden="true"></i></button>  </div>'); 
    
            arrSocios.push(arrSocio);
    ...
    //***************************************************trae valores de y Empresa si ya exiten (ciudad)*******************
 ...
 function obtenerDepartamentos() {
    url = 'paises/'+ 170 +'/departamentos';
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(respuesta) {
                // crearDepartamentos(respuesta.data);
    ...
    var url_index = 'miempresa/edit.html';
    ...
    let id = $('#decimale').val();
      ...
      $('#mymodal').load('../miempresa/decimale/edit.html',function(){
            $('#ModalLong2').modal({show:true});
      });
    };
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            if(respuesta.data.socios){
                generarDataTable(organizarDatos(respuesta.data.socios));
            }
