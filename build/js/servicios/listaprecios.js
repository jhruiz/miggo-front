$("#formPrecio").submit(function(e) {
    ...
    function enviaLista(k){
      ...
      if(lista){
        ...
        formData.append('_method', 'PUT');
             ...
             $.ajax({
              method: "POST",
              url: url_back + "listaprecios/"+lista,
              headers: { 
    ...
    e.preventDefault(); 
      ...
      var servicio_id = localStorage.editar;
    ...
    function validarCostounitario(e){
      ...
      if(parseInt($(this).val()) < parseInt($('#costounitario').val())){
    ...
    $.ajax({
        ...
        success: function(respuesta) {
          ...
          arre = respuesta.data.listaprecios;
